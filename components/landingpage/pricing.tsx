...
const tiers = [
    {
        ...
        href: '#',
        priceMonthly: '$0',
        description: "Get started with CleverMart at no cost and explore the essentials.",
        features: [
            'List Anything',
            'Smart Pricing',
            'Secure Transaction',
            ...
            <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
                {tiers.map((tier, tierIdx) => (
                    ...
                    >
                        <h3
                            id={tier.id}
                            className={classNames(tier.featured ? 'text-gray-400' : 'text-gray-600', 'text-base/7 font-semibold')}
                        >
                            {tier.name}
                        </h3>
                        ...
                        >
                            {tier.features.map((feature) => (
                                <li key={feature} className="flex gap-x-3">
                                    <CheckIcon
                                        aria-hidden="true"
                                        className={classNames(tier.featured ? 'text-gray-400' : 'text-gray-600', 'h-6 w-5 flex-none')}
                                    />
                                    {feature}
                                </li>
                            ))}
                        ...
                        <a
                            ...
                            className={classNames(
                                tier.featured
                                    ...
                                    : 'text-gray-600 ring-1 ring-inset ring-gray-200 hover:ring-gray-300 focus-visible:outline-gray-600',
