        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div className="sm:max-w-lg">
            ...
            <p className="mt-4 text-xl text-gray-500 dark:text-gray-400">
              Your Ultimate Marketplace for Anything - here is your chance to
              refresh your wardrobe, home, garage without breaking the bank.
              CleverMart is the smart way to buy, sell, and trade anything –
              connecting you with people, saving you money, and giving anything
              a second life.
            </p>
          </div>
          <div>
            <div className="mt-10">
              ...
              <a
                href="/sign-in"
                className="inline-block rounded-md border border-transparent bg-gray-500 dark:bg-gray-500 px-8 py-3 text-center font-medium text-white hover:bg-gray-500 dark:hover:bg-gray-600"
              >
                Get Started
              </a>
            </div>
